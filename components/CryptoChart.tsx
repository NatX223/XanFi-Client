  ...
  return (
    <>
      <section className="pt-[14rem]">
        <h2 className="text-center text-3xl font-medium mb-10">Track sector performance</h2>
        <h3 className="text-center text-2xl font-medium mb-8">Track sector performance</h3>
          ...
          <div className="mx-auto">
            <ResponsiveContainer aspect={6.0 / 2.0} width="100%">
              <AreaChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                ...
                <Legend />
                <Area type="monotone" dataKey="performance" stroke="#FA7E0C" fill="url(#areaGradient)" strokeWidth={3} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
